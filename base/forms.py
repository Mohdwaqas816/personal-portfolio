...
from .models import Comment, Endorsement, Project, Message, Skill, Question
...
class ProjectForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['body'].widget.attrs.update({'class': 'form-control', 'placeholder': 'Enter the body..'})
